...
=======
		...
		en1 = new Enemy(x + 1500, y + 2000, 336, 48, "Sprites/Monster.png",10, handler);
		handler.addObject(1, en1);
		en2 = new Enemy(x + 2253, y + 2470, 336, 144, "Sprites/Monster.png",10, handler);
		handler.addObject(1, en2);
		en3 = new Enemy(x + 2698, y + 2640, 336, 0, "Sprites/Monster.png",10, handler);
		handler.addObject(1, en3);
		en4 = new Enemy(x + 3080, y + 2280, 336, 0, "Sprites/Monster.png",10, handler);
		handler.addObject(1, en4);
		en5 = new Enemy(x + 2253, y + 2170, 336, 96, "Sprites/Monster.png",10, handler);
		handler.addObject(1, en5);
		en6 = new Enemy(x + 2440, y + 1980, 336, 144, "Sprites/Monster.png",10, handler);
